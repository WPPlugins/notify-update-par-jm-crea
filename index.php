...
$email_nu_wordpress .= '<p>Votre version de Wordpress <strong>(' . get_bloginfo('version') . ')</strong> est disponible en version <strong>' . $update_core->updates[0]->current . '</strong></p>';
$sms_nu_wordpress .= 'Votre version de Wordpress (' . get_bloginfo('version') . ') est disponible en version ' . $update_core->updates[0]->current;
$wordpress_maj = 'OK';
}
...
$email_nu_theme .= '<p>Une nouvelle version pour votre thème "' . $theme_info['Name'] . '" est disponible. La version version ' . $theme_info['Version'] . ' est disponible en version ' . $value['new_version'] . '</p>' ;
$sms_nu_theme .= 'Une nouvelle version pour votre thème "' . $theme_info['Name'] . '" est disponible. La version version ' . $theme_info['Version'] . ' est disponible en version ' . $value['new_version'];
$theme_maj = 'OK';
}
}
...
echo("<meta name='Notify Update par JM Créa' content='2.1' />\n");
}
